...
document.addEventListener('click', function(event) {
  ...
  form.addEventListener('submit', (e) => {
    ...
    if (answer1 === 'No' || answer2 === 'No' || answer3 === 'No' || answer4 ==='No') {
      ...
      message.textContent = 'You are eligible.Application form for kcc: https://sbi.co.in/documents/14463/22577/application+form.pdf/24a2171c-9ab5-a4de-08ef-7a5891525cfe ';
    }
  });
